...
export default function LandingLiveDemoSimulation() {
    ...
    const [kitchenItems, setKitchenItems] = useState([
        {
            id: 1,
            name: "Truffle Tagliatelle & Parmigiano",
            qty: 2,
            mod: "Extra Truffle • Gluten-Free",
            status: "preparing",
            time: "3m 40s",
            urgent: false,
            img: "/media/pasta.jpg",
        },
        {
            ...
            qty: 1,
            mod: "Brioche Bun • Caramelized Onions",
            status: "ready",
            time: "1m 15s",
            urgent: false,
        ...
        <section id="stations" className="relative py-12 md:py-16">
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-2xl mx-auto">
                    <div className="inline-flex items-center gap-1.5 rounded-full border border-border/80 bg-secondary/60 px-3 py-0.5 text-[11px] font-medium text-muted-foreground">
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    ...
                                    isActive
                                        ? "border-foreground/30 bg-foreground text-background shadow-xs"
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
                                    <div className="rounded-xl border border-border/80 bg-background/60 p-4 space-y-3">
                                        ...
                                        >
                                            ...
                                            />
                                            <span>
                                                Re-Validate Transfer Reference
                                            </span>
                                        </button>
                                    </div>
                                    ...
                                    <div className="rounded-xl border border-orange-500/30 bg-orange-500/5 p-3 flex flex-col justify-between">
                                        <div>
                                            ...
                                            <p className="mt-1 text-[11px] text-muted-foreground">
                                                Instant shift audit balancing
                                                cash drops, TinaVerify slips &
                                                Register custody.
                                            </p>
                                        </div>
                                        <button
