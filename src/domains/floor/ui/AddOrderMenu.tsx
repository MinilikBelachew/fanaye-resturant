    ...
    return (
        ...
        >
            ...
            >
                <div className="flex shrink-0 items-start justify-between gap-4 border-b border-hairline px-5 py-4">
                    <div>
                        ...
                        <p className="mt-0.5 text-[13px] text-slate-gray">
                            {data?.activePeriod
                                ? `${data.activePeriod.name} · tap dishes, then send to the station.`
                                : "Tap dishes to select. Use Options for toppings."}
                        </p>
                    </div>
                    <button
                        type="button"
                                            ...
                                            return (
                                                <article
                                                    ...
                                                    className={cn(
                                                        ...
                                                        !item.available
                                                            ? "border-hairline bg-secondary/50 opacity-60 grayscale"
                                                            : count > 0
                                                            ...
                                                            <div className="flex items-center gap-1.5">
                                                                ...
                                                                {count > 0 ? (
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="flex size-8 items-center justify-center rounded-full border border-hairline bg-card hover:bg-accent"
                                                                    >
                ...
                {error ? (
                    <p className="px-5 pt-2 text-[13px] text-red-600">
                        {error}
                    </p>
                ) : null}
